...
String id = session.getAttribute("userid").toString();
      ...
      out.write("/Request\" enctype=\"multipart/form-data\" method=\"post\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t\t<td colspan=\"3\" align=\"center\"><font style=\"font-family:Arial;font-size: 20px;color: White;\"><b>Key Request Process</b></font></td>\r\n");
      out.write("\t\t\t     \t</tr>\r\n");
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      ...
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t<td>Your UserID is :</td>\r\n");
      out.write("\t\t\t     \t\t<td>:</td>\r\n");
      out.write("\t\t\t     \t\t<td>\r\n");
      out.write("\t\t\t     \t\t\t<input class=\"field\" type=\"text\" name=\"uid\" value=\"");
      out.print(id );
      ...
      out.write("\t\t\t     </table>\r\n");
      out.write("\t\t\t     \r\n");
      out.write("\t\t\t\t<input class=\"gradientbuttons\" type=\"submit\" value=\"Send Request\" style=\"position:absolute;top:200px;left:150px;\"/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("</form>\r\n");
      out.write("\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==1)
    {
      ...
      out.write("    \t\t<p>Key Request has been sent Successfully...!</p>\r\n");
      out.write("    \t</div>\t\t\t\r\n");
      out.write("    ");
}
